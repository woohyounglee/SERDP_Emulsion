...
original_questions = {
     ...
     'Fixed surfactant information':{
          'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': ['87 ~ 3824'],
          ...
          'Alkalinity (mg CaCO<sub>3</sub>/L)': ['0 ~ 6014'],
...
type_questions = {
     ...
     'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': 'editbox',
     ...
     'Alkalinity (mg CaCO<sub>3</sub>/L)': 'editbox',
...
enable_questions = {
     ...
     'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': 'false',
     ...
     'Alkalinity (mg CaCO<sub>3</sub>/L)': 'false',
...
default_values = {
    ...
    'AFFF': {
          ...
          'Alkalinity (mg CaCO<sub>3</sub>/L)': 68.9,
          "Surfactant's Initial pH at 7CMC": 6.8,
     },
     'B&B': {
               'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': 361,
               ...
               'Alkalinity (mg CaCO<sub>3</sub>/L)': 21,
               "Surfactant's Initial pH at 7CMC": 8.8,
          },
     'Blast': {
               'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': 934,
               ...
               'Alkalinity (mg CaCO<sub>3</sub>/L)': 171,
               "Surfactant's Initial pH at 7CMC": 10.5,
          },
     'Calla': {
               'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': 328,
               ...
               'Alkalinity (mg CaCO<sub>3</sub>/L)': 27.1,
               "Surfactant's Initial pH at 7CMC": 8.6,
          },
     'Powergreen': {
               'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': 3824,
     ...
     'SDS': {
               ...
               'Alkalinity (mg CaCO<sub>3</sub>/L)': 7.4,
               "Surfactant's Initial pH at 7CMC": 6.3,
          },
     'Surge': {
               'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': 98,
               ...
               'Alkalinity (mg CaCO<sub>3</sub>/L)': 412.5,
               "Surfactant's Initial pH at 7CMC": 12.2,
          },
     'Triton-X-100': {
               'Critical micelle concentration (CMC<sub>log</sub>) (ppm)': 102,
